...
@Module({
  providers: [
    ...
    { provide: GUEST_REPOSITORY, useClass: PrismaGuestRepository },
    {
      ...
      useClass: PrismaGuestAccountRepository,
    },
    ...
    { provide: CART_REPOSITORY, useClass: PrismaCartRepository },
    {
      ...
      useClass: PrismaExperiencePurchaseRepository,
    },
    {
    ...
    { provide: SUPPLIER_REPOSITORY, useClass: PrismaSupplierRepository },
    {
      ...
      useClass: PrismaInventoryItemCategoryRepository,
    },
    ...
    { provide: SHIFT_REPOSITORY, useClass: PrismaShiftRepository },
    {
      ...
      useClass: PrismaGuestPreferenceCatalogRepository,
    },
    ...
    },
    {
      ...
      useClass: PrismaPaymentSessionRepository,
    },
    {
      provide: GUEST_MESSAGE_REPOSITORY,
      useClass: PrismaGuestMessageRepository,
    },
    {
